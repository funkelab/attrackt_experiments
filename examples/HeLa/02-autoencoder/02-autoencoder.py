...
model_checkpoint = f"autoencoder-2025-10-21-{suffix}/models_autoencoder/best.pth"  # Path to a saved model checkpoint. Modify accordingly.
...
# Uncomment the next few lines to infer using the trained model.
